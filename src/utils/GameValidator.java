...
public class GameValidator {
	...
	public static boolean validateCoordinates(ArrayList<Coordinate> coordinates){
	...
	private static boolean validateHorizontalPlacement(ArrayList<Coordinate> coordinates){
	...
	private static boolean validateVerticalPlacement(ArrayList<Coordinate> coordinates){
